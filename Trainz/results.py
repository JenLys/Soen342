...
class Trip:
    ...
    # this one counts the trip durations alone, without in-between waiting time
    ...
    # find connections that will form trips from dep(arture)_station to arr(ival)_station
